...
class ContentRecommendationEngine:
        ...
        try:
            ...
            if track:
                return {
                    ...
                    'collectionName': track.get('collectionName', 'Unknown'),
    ...
    def _get_realtime_track_similarity(self, current_track_id, user_mood, limit, purchased_tracks):
        """Real-time similarity với diversity"""
        ...
        try:
            ...
            similar_tracks_cursor = self.tracks_db.find(query).limit(limit * 5)
